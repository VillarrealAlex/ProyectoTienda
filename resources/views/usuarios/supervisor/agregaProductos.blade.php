            ...
            <div class="container-fluid">
                    ...
                    <div class="table-wrapper">
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-6">
                                    <h3>Administrar <b> Productos de: </b><b style="color:red"> {{$prod->nombre}} ID({{$prod->id}})</b></h3>
                                </div>
                                         ...
                                         @forelse ($productos as $producto)
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <form style="margin-top: 10px; margin-left:16px" action="eliminar/categoria/{{$producto->id}}" method="POST" onsubmit="return confirm('Desea eliminar este elemento?');">
                                                            @csrf
                                                            @method('DELETE')
