    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
          ...
          <div class="container-fluid">
              <form method="POST"  action="configuracion/{{Auth::user()->id}}">
                  {{ csrf_field() }}
                  ...
                  <button style="margin-left: 100pt" type="submit" class="btn btn-primary">Confirmar</button>
            </form>

            <form onsubmit="return confirm('Está seguro de eliminar su cuenta?. Esta accion no se puede deshacer');" style="margin-top: 30pt; margin-left:20pt"  action="eliminar-cuenta/{{Auth::user()->id}}" method="post">
                @csrf
				@method('DELETE')
                <div class="form-row">
